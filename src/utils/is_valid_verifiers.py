...
class IsValidVerifiers:
    ...
    @staticmethod
    def program_code(program_code, edit_state=True):
        if not edit_state:
    ...
    @staticmethod
    def program_name(program_name, edit_state=True):
        if not edit_state:
    ...
    @staticmethod
    def college_code(college_code, edit_state=True):
        if not edit_state:
    ...
    @staticmethod
    def college_name(college_name, edit_state=True):
        if not edit_state:
