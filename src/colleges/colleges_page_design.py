...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.delete_college_button.setMinimumSize(QtCore.QSize(160, 30))
        ...
        self.gridLayout.addWidget(self.delete_college_button, 6, 2, 1, 2)
        ...
        self.add_college_button.setMinimumSize(QtCore.QSize(160, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.colleges_table = QtWidgets.QTableWidget(parent=self.centralwidget)
        self.colleges_table.setMaximumSize(QtCore.QSize(680, 16777215))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.colleges_table.setFont(font)
        self.colleges_table.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.colleges_table.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.colleges_table.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        self.colleges_table.setObjectName("colleges_table")
        self.colleges_table.setColumnCount(3)
        self.colleges_table.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.colleges_table.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.colleges_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.colleges_table.setHorizontalHeaderItem(2, item)
        self.colleges_table.horizontalHeader().setVisible(True)
        self.colleges_table.horizontalHeader().setCascadingSectionResizes(True)
        self.colleges_table.horizontalHeader().setDefaultSectionSize(330)
        self.colleges_table.horizontalHeader().setMinimumSectionSize(90)
        self.colleges_table.horizontalHeader().setSortIndicatorShown(True)
        self.colleges_table.verticalHeader().setVisible(False)
        self.gridLayout.addWidget(self.colleges_table, 3, 0, 1, 6)
        ...
        self.edit_college_button.setMinimumSize(QtCore.QSize(160, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.gridLayout.addWidget(self.edit_college_button, 5, 3, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.colleges_table.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Order ID"))
        item = self.colleges_table.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "College Code"))
        item = self.colleges_table.horizontalHeaderItem(2)
