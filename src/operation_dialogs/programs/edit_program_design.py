...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(475, 360)
        Dialog.setMinimumSize(QtCore.QSize(475, 360))
        Dialog.setMaximumSize(QtCore.QSize(475, 360))
        ...
        self.edit_program_button.setMinimumSize(QtCore.QSize(427, 35))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        ...
        self.new_college_code_combobox.setMinimumSize(QtCore.QSize(220, 23))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_2.addWidget(self.new_college_code_label, 5, 1, 1, 1)
        self.program_to_edit_label = QtWidgets.QLabel(parent=self.frame)
        self.program_to_edit_label.setMinimumSize(QtCore.QSize(165, 0))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.gridLayout_2.addWidget(self.program_to_edit_label, 1, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_2.addItem(spacerItem3, 3, 4, 3, 1)
        spacerItem4 = QtWidgets.QSpacerItem(10, 15, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_2.addItem(spacerItem4, 3, 0, 3, 1)
        ...
        self.gridLayout_2.addWidget(self.new_program_name_label, 4, 1, 1, 1)
        self.new_program_name_lineedit = QtWidgets.QLineEdit(parent=self.frame)
        self.new_program_name_lineedit.setEnabled(True)
        self.new_program_name_lineedit.setMinimumSize(QtCore.QSize(220, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_2.addWidget(self.new_program_name_lineedit, 4, 3, 1, 1)
        self.new_program_code_lineedit = QtWidgets.QLineEdit(parent=self.frame)
        self.new_program_code_lineedit.setEnabled(True)
        self.new_program_code_lineedit.setMinimumSize(QtCore.QSize(220, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_2.addWidget(self.new_program_code_lineedit, 3, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.new_program_code_label, 3, 1, 1, 1)
        self.program_to_edit_list = QtWidgets.QLabel(parent=self.frame)
        self.program_to_edit_list.setMinimumSize(QtCore.QSize(0, 79))
        self.program_to_edit_list.setMaximumSize(QtCore.QSize(16777215, 79))
        self.program_to_edit_list.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.program_to_edit_list.setWordWrap(True)
        self.program_to_edit_list.setObjectName("program_to_edit_list")
        self.gridLayout_2.addWidget(self.program_to_edit_list, 1, 3, 1, 2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.new_college_code_combobox.setItemText(0, _translate("Dialog", "--Select a college--"))
        self.new_college_code_label.setText(_translate("Dialog", "New College Code"))
        self.program_to_edit_label.setText(_translate("Dialog", "Program To Be Edited"))
        ...
        self.program_to_edit_list.setText(_translate("Dialog", "TextLabel"))
