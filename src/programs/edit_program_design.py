...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(420, 310)
        Dialog.setMinimumSize(QtCore.QSize(420, 310))
        Dialog.setMaximumSize(QtCore.QSize(420, 1000))
        ...
        self.gridLayout.addWidget(self.edit_program_button, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addItem(spacerItem4, 2, 4, 4, 1)
        ...
        self.new_program_name_lineedit.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.new_program_code_lineedit.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setBold(True)
        font.setWeight(75)
